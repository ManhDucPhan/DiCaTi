...
public class FormImei extends javax.swing.JFrame {
    ...
    public void loadTb() {
        ArrayList<ImeiViewModel> listimei = imeiService.getAll();

        DefaultTableModel model = (DefaultTableModel) tblimei.getModel();
        model.setRowCount(0);
        for (ImeiViewModel x : listimei) {
            model.addRow(new Object[]{x.getMaImei(), x.getTrangThai(), x.getId_Sp()});
        }
    }

    public void loadTbXoa() {
        ArrayList<ImeiViewModel> listimei = imeiService.getAllXoa();
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtmaimei, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 87, 202, -1));
        ...
        jPanel2.add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 50, -1));
        ...
        jPanel2.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, 50, -1));
        ...
        jPanel2.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 250, 50, -1));
        ...
        jPanel2.add(rdo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 150, -1, -1));

        buttonGroup1.add(rdo2);
        rdo2.setText("Offline");
        jPanel2.add(rdo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 150, -1, -1));

        buttonGroup1.add(rdo3);
        rdo3.setText("Đang chờ hàng về");
        jPanel2.add(rdo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, -1, -1));

        buttonGroup1.add(rdo4);
        rdo4.setText("Ngừng bán");
        jPanel2.add(rdo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 180, -1, -1));

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 1, 13)); // NOI18N
        jLabel4.setText("Trạng thái");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 127, -1, -1));
        ...
        jPanel2.add(cbxIdSp, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 210, 130, -1));
    ...
    private void tblimeiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblimeiMouseClicked
        ...
        cbxIdSp.setSelectedItem(tblimei.getValueAt(row, 2).toString());
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        imei.setId_Sp((String) cbxIdSp.getSelectedItem());
...
//        loadTbXoa();
        ...
        String imei = tblimei.getValueAt(row, 0).toString();
        imeiService.delete(imei);
